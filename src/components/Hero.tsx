...
export default function Hero({ setActiveSection }: HeroProps) {
  ...
  const badges = [
    { icon: Music, number: '10+', label: 'AÑOS', delay: 0.2 },
    { icon: Disc3, number: '4', label: 'ÁLBUMES', delay: 0.4 },
    { icon: Calendar, number: '50+', label: 'SHOWS', delay: 0.6 }
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 px-4">
      ...
      {/* Dark overlay layer */}
      <div className="absolute inset-0 z-1 bg-gradient-to-b from-black/85 via-black/90 to-black/95"></div>

      {/* Accent overlay with noise effect */}
      ...
      <div className="relative z-10 text-center max-w-6xl w-full">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-3 mb-8">
            ...
            <div className="flex justify-center gap-3">
              ...
              <p className="text-lg md:text-xl text-red-500 font-bold tracking-widest">NORORIENTAL</p>
        ...
        {/* Description */}
        <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto mb-16 leading-relaxed font-medium animate-fade-in-up"
          style={{
              ...
              return (
                ...
                >
                    ...
                    >
                      ...
                      <p className="absolute -bottom-10 left-1/2 -translate-x-1/2 text-xs text-gray-400 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        {badge.desc}
                      </p>
                    </div>
                  </div>
        ...
        >
          ...
          <button
            ...
            className="group relative px-8 py-4 md:py-5 text-red-600 font-black text-base md:text-lg tracking-widest overflow-hidden transition-all duration-300 transform hover:scale-110 hover:-translate-y-1"
            style={{
